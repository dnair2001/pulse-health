...
const PROVIDER_REQUIRED_MESSAGE = 'Please choose a provider.';
export const SLOT_REQUIRED_MESSAGE = 'Please choose a time slot.';
const VISIT_TYPE_REQUIRED_MESSAGE = 'Please choose a visit type.';
 ...
 */
const REASON_MAX_LENGTH_MESSAGE = `Please keep the reason to ${REASON_MAX_LENGTH} characters or fewer.`;
